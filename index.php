...
<body>
  ...
  <main id="view-panel">
    <?php 
      ...
      $allowed_pages = ['home', 'db_connect', 'payments', 'borrowers', 'loans','loan_type','plan','users','crypt']; // Allowed pages
      if (!in_array($page, $allowed_pages)) {
          $page = 'home'; // Default to 'home' if the page is not allowed
      }
      include $page . '.php'; // Dynamically include the corresponding page
    ?>
  </main>
